    ...
    for mode in ["1TO5", "5TO60"]:
        ...
        for path in paths:
            ...
            for p,n,f in os.walk(os.getcwd()):
                docontinue = False
                if symbols != "ALL" and symbols not in os.path.basename(p):
                    continue
                ...
                for a in f:
                    ...
                    if a.endswith('.csv'):
                        ...
                        newfile = os.path.join(newdir,a)
                        if ow == False and os.path.exists(newfile):
                            continue
#                        globvars.logger.info("checking %s %s %s",str(p),str(a), dstdir)
